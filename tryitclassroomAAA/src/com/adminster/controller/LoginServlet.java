package com.adminster.controller;
...
import com.adminster.model.AdminsterService;
import com.adminster.model.AdminsterVO;
...
public class LoginServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request,
		...
		AdminsterService ls = new AdminsterService();
		// 呼叫 ls物件的 checkIDPassword()，要記得傳入userid與password兩個參數
		// 同時將傳回值放入MemberBean型別的變數mb之內。
		AdminsterVO mb = ls.checkIDPassword(userId, password);
		...
		if (errorMsgMap.isEmpty()) {
			...
			if (target != null) {
                ...
                response.sendRedirect(
			      response.encodeRedirectURL(contextPath + "/Supplier_DataTables.html" ));
